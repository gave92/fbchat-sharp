...
namespace System.Collections.Async
{
    ...
    public static class ParallelForEachExtensions
    {
        ...
        /// <param name="maxDegreeOfParalellism">Maximum items to schedule processing in parallel. The actual concurrency level depends on TPL settings. Set to 0 to choose a default(CancellationToken) value based on processor count.</param>
        ...
        /// <param name="gracefulBreak">If True (the default(CancellationToken) behavior), waits on completion for all started tasks when the loop breaks due to cancellation or an exception</param>
